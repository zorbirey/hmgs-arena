...
const output = path.join(root, 'web-demo', 'assets', 'visual-20260823-02');
...
render('native-android/app/src/main/assets/zeus_cover_v2.svg', 'entry-zeus-20260823-02.png', 1080);
render('assets/zeus_hmgs.svg', 'brand-zeus-20260823-02.png', 1080);
render('native-android/app/src/main/assets/zeus_watermark_v2.svg', 'watermark-zeus-20260823-02.png', 810);

for (const size of [64, 180, 192, 512]) {
  render('assets/hmgs_arena_icon.svg', `icon-${size}-20260823-02.png`, size);
}
...
fs.writeFileSync(
  path.join(output, 'icon-maskable-512-20260823-02.png'),
